...
<section id="feature" class="section-padding wow fadeIn delay-05s">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">Si he logrado...</h2>
            <p class="sub-title pad-bt15">Ver más lejos, ha sido por que he subido<br>
            a hombros de gigantes.</p>
            <hr class="bottom-line">
          </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="service-item">
                <a href="#"><img src="img/about.jpg" alt="" class="img-max-zise"></a>
                <div class="blog-comment text-center">
                    <span>Comentarios: <a href="#"><i class="fa fa-comments"></i></a> 15</span> <br>
                    <span>Visitas: <a href="#"><i class="fa fa-eye"></i></a> 11</span></p>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="service-item">
              <a href="#"><img src="img/bg-banner.jpg" alt="" class="img-max-zise"></a>
                <div class="blog-comment text-center">
                    <span>Comentarios: <a href="#"><i class="fa fa-comments"></i></a> 15</span> <br>
                    <span>Visitas: <a href="#"><i class="fa fa-eye"></i></a> 11</span></p>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="service-item">
              <a href="#"><img src="img/male.png" alt="" class="img-max-zise"></a>
                <div class="blog-comment text-center">
                    <span>Comentarios: <a href="#"><i class="fa fa-comments"></i></a> 15</span> <br>
                    <span>Visitas: <a href="#"><i class="fa fa-eye"></i></a> 11</span></p>
                </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="service-item">
              <a href="#"><img src="img/ser01.png" alt="" class="img-max-zise"></a>
                <div class="blog-comment text-center">
                    <span>Comentarios: <a href="#"><i class="fa fa-comments"></i></a> 15</span> <br>
                    <span>Visitas: <a href="#"><i class="fa fa-eye"></i></a> 11</span></p>
                </div>
    ...
    <section id="portfolio" class="section-padding wow fadeInUp delay-05s">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">Artículos Recientes</h2>
